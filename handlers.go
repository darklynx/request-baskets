...
var indexPageTemplate = template.Must(template.ParseFiles("/lib/rbaskets/templates/index.html"))
var basketPageTemplate = template.Must(template.ParseFiles("/lib/rbaskets/templates/basket.html"))
var basketsPageTemplate = template.Must(template.ParseFiles("/lib/rbaskets/templates/baskets.html"))
